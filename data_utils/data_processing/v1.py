...
def process_and_save_data():
    ...
    try:
        ...
        print("Lỗi: Không tìm thấy dataset gốc tại 'data/subset_openmathinstruct_1/256K'")
        return
    ...
    # Process với max_length=1024 (nhưng output sẽ ngắn hơn, tùy mẫu)
    ...
    print(f"Dev samples:   {len(dev_processed)}")
    print(f"Test samples:  {len(test_processed)}")
    print("Lưu ý: Data này có độ dài không đồng đều (chưa padding).")
    print("Bắt buộc dùng DataCollatorForSeq2Seq(padding=True) khi train.")
