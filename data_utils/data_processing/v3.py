...
class DataPreprocessing:
    ...
    def process_example(self, example, max_length=1024):
        ...
        instruction = (
            "Solve the given math problem step by step. You have three approaches:\n\n"
            "1. **Code-based solution**: Directly solve using Python code wrapped in <llm-code>...</llm-code> tags.\n"
            "   Example: <llm-code>result = 2 + 2</llm-code> followed by <llm-code-output>4</llm-code-output>\n\n"
            "2. **Reasoning + Code**: First explain the mathematical reasoning, then verify with code.\n"
            "   Example: Explain the formula or approach, then implement it in <llm-code>...</llm-code>\n\n"
            ...
            "The answer inside \\boxed{} should be a single number or simplified expression."
        )
...
def process_and_save_data():
    ...
    print("\n=== KẾT QUẢ XỬ LÝ V3 (IMPROVED INSTRUCTION TUNING) ===")
